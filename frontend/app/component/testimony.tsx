...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Broka has completely changed how I trade. The real-time data is incredibly accurate, and the execution speed is unmatched. I've never felt more confident managing my portfolio.",
    country: "Singapore"
  },
  {
    name: "Fatima Okoro",
    ...
    rating: 5,
    text: "As a beginner, I was nervous about crypto. Broka made everything so simple and secure. The educational tools and instant notifications helped me make my first profitable trades.",
    country: "Nigeria"
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Do not just take our word for it — hear from real users who trade with Broka every day.
          </p>
        </div>
