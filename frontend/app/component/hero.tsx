...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16 md:pt-0 overflow-hidden">
      ...
      {/* 🌌 Gradient Background */}
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-zinc-950 via-indigo-950/20 to-purple-950/20">
      ...
      >
        <div className="w-[500px] h-[500px] md:w-[800px] md:h-[800px] opacity-80">
          <AnimationIcon />
        </div>
      </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          >
            <Link
              href="/signup"
              className="group relative px-10 py-6 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl font-bold text-lg shadow-2xl shadow-purple-500/30 hover:scale-[1.03] transition-all duration-400 overflow-hidden"
            >
