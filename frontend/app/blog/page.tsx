  ...
  const posts = [
    {
      ...
      excerpt: 'Learn the basics of cryptocurrency trading and how to make your first trade on Broka.',
      author: 'Sarah Chen',
      date: 'Mar 28, 2026',
      category: 'Trading',
      readTime: '5 min read',
      ...
      <section className="relative pt-28 pb-12 px-6">
        ...
        >
          ...
          <p className="text-xl text-zinc-300 mb-8">
            Market insights, trading tips, and crypto news from the Broka team.
          </p>
        </motion.div>
      </section>
